...
def seed_data(conn):
    ...
    """, [
        ...
        ("UA999", 4, 5, "2025-10-10T09:00:00", "2025-10-10T11:30:00", 4, 300.0),
    ])
    ...
    """, [
        ...
        (5, 4, "BOOKED", datetime.now().isoformat(), 310.0),
        (6, 2, "BOOKED", datetime.now().isoformat(), 95.0),
    ])
    ...
    """, [
        ...
        ("customer1", hash_password("custpass", salt3), salt3, "CUSTOMER"),
    ])
...
def run_queries(conn):
    ...
    for row in cur.execute("""
        SELECT f.code, a1.code AS departure, a2.code AS arrival,
